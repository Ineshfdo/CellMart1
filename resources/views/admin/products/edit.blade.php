                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="border-2 border-dashed border-gray-300 dark:border-zinc-600 rounded-lg p-4 flex items-center justify-center bg-gray-50 dark:bg-zinc-900">
                                    @if($product->image)
                                        @php
                                        ...
                                        <img id="currentImage" 
                                             src="{{ $imageSrc }}" 
                                             alt="{{ $product->name }}" 
                                             class="max-w-full h-48 object-contain rounded-lg"
                            ...
                            <!-- Upload New Image -->
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">Upload New Image (Optional)</p>
                                <div class="border-2 border-dashed border-gray-300 dark:border-zinc-600 rounded-lg p-4 bg-gray-50 dark:bg-zinc-900">
                                    <input type="file" 
                                           id="imageUpload" 
                                           name="image_file" 
                                           accept="image/*"
                                    ...
                                    <div id="newImagePreview" class="mt-4 hidden">
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">New Image Preview:</p>
                                        <img id="previewImg" src="" alt="Preview" class="max-w-full h-32 object-contain rounded-lg border border-gray-200 dark:border-zinc-700">
                                    </div>
                                </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" 
                                  name="description" 
                                  rows="4"
                                  class="w-full px-4 py-2 border border-gray-300 dark:border-zinc-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-zinc-700 text-gray-900 dark:text-white">{{ old('description', $product->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
